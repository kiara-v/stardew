function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const UPDATE_INTERVAL = 20;
...
class App extends React.Component {
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(FishingGui, null)));
...
class FishingGui extends React.Component {
  constructor(props) {
    super(props);_defineProperty(this, "mouseDownHandler",
    ...
    event => {
      ...
      this.reeling = false;
    });_defineProperty(this, "updateHandler",
    () => {
      try {
        this.updateSlide();
        this.updateFish();
    ...
    });_defineProperty(this, "setFishMovement",
    () => {
      this.fishTicks = 0;
    ...
    });_defineProperty(this, "updateFish",
    () => {
      this.fishTicks++;
    ...
    });_defineProperty(this, "updateSlide",
    () => {
      if (this.reeling) {
    ...
    });this.state = { reelStyle: ANIMATION_STYLE_PAUSE };this.updateInterval = null;this.reeling = false;this.slideBottom = FISHING_SLIDE_MIN_BOTTOM;this.slideAcc = 0;this.fishBottom = FISH_MIN_BOTTOM;this.progressPercent = 50;this.onFish = false;this.fishTicks = 0;this.fishAcc = 0;this.fishAccFalloff = 0;this.fishNextUpdate = 0;this.fishReverse = false;this.fishDrift = 0;this.setFishMovement();this.slideRef = React.createRef();this.fishRef = React.createRef();this.progressRef = React.createRef();}componentDidMount() {window.addEventListener('mousedown', this.mouseDownHandler);window.addEventListener('mouseup', this.mouseUpHandler);this.updateInterval = setInterval(this.updateHandler, UPDATE_INTERVAL);}componentWillUnmount() {window.removeEventListener('mousedown', this.mouseDownHandler);window.removeEventListener('mouseup', this.mouseUpHandler);if (this.updateInterval) {clearInterval(this.updateInterval);}}
  render() {
    const { reelStyle, slideStyle } = this.state;

    return /*#__PURE__*/(
      React.createElement("div", { className: "fishing-wrapper" }, /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-wrapper" }, /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole" }, /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-segment" }), /*#__PURE__*/
      ...
      React.createElement("div", { className: "fishing-pole-handle" }), /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-reel" }, /*#__PURE__*/
      React.createElement("div", { className: "fishing-pole-reel-handle rotating", style: reelStyle }))), /*#__PURE__*/


      React.createElement("div", { className: "bamboo-wrapper" }, /*#__PURE__*/
      React.createElement("div", { className: "bamboo-col" }, /*#__PURE__*/
      React.createElement("div", { className: "bamboo-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "bamboo-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "bamboo-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "bamboo-segment" }), /*#__PURE__*/
      React.createElement("div", { className: "bamboo-segment" })), /*#__PURE__*/

      React.createElement("div", { className: "fishing-slide-wrapper" }, /*#__PURE__*/
      React.createElement("div", { className: "bamboo-row" }), /*#__PURE__*/
      React.createElement("div", { className: "fishing-slide strobing", ref: this.slideRef }), /*#__PURE__*/
      React.createElement("i", { className: "fas fa-fish fishing-icon", ref: this.fishRef }), /*#__PURE__*/
      React.createElement("div", { className: "bamboo-row" })), /*#__PURE__*/
      ...
      React.createElement("div", { className: "fishing-progress-wrapper" }, /*#__PURE__*/
      React.createElement("div", { className: "fishing-progress-bar", ref: this.progressRef }))));
